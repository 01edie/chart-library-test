        ...
        <Grid container spacing={2}>
          <Grid item xs={12} lg={6}>
            <Stack justifyContent='end' position='relative' direction='row'>
                <Typography sx={{position:'absolute', left:'50%',top:'50%', transform:"translate(-50%,-50%)"}}>Sales of { timeline}</Typography>
              <Button
                variant="contained"
            ...
            <div style={{width:'16px',height:'16px',backgroundColor: colors.green[500], borderRadius:'2px'}}></div>
